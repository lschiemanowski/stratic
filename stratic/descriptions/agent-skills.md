...
The bundled skill guides investigation, description maintenance, evidence recording, preparation, and user-authorized acceptance. It identifies the executable through its product and project format so another installed Stratic generation is not mistaken for this one.
